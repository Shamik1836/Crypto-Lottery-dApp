          ...
          <div className="stats-container space-y-2">
            <div className="stats-container">
              ...
              <div className="space-y-2 mt-5">
                <div className="font-extrabold flex items-center justify-between text-emerald-300 text-sm italic">
              ...
              <button
                ...
                onClick={handleClick}
                className="font-semibold mt-5 w-full bg-gradient-to-br from-orange-500 to-emerald-600 px-10 py-5 rounded-md text-white shadow-xl disabled:from-gray-100 disabled:to-gray-600 disabled:cursor-not-allowed"
              >
